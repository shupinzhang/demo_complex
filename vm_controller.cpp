...
bool VMController::setDoorSwitch(int numbering, bool on_off)
{
    ...
    QByteArray tx_data;
    tx_data.append('C');
    tx_data.append(QString::number(numbering));
...
bool VMController::executeChannel(int ch1_row, int ch1_col, int ch2_row, int ch2_col)
{
    ...
    if (ch2_row < 0 || ch2_col < 0) {
        is_single_ = true;
        tx_data.append("CH");
        tx_data.append(QString::number(ch1_row));
        tx_data.append(QString::number(ch1_col));
        tx_data.append('\n');
        ...
        tx_data.append(QString::number(ch1_row));
        tx_data.append(QString::number(ch1_col));
        tx_data.append(QString::number(ch2_row));
        tx_data.append(QString::number(ch2_col));
        tx_data.append('\n');
